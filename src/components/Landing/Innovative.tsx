...
const Innovative: React.FC = () => {
	const renderTitleDescGridContent = (title: string, description: string, theme = 'light') => {
		return (
			<>
				<h3 className={ clsxm(
	...
	const renderGridItem = (item: any) => {
		switch (item.id) {
			case '1': return renderDashboardContent(item);
			case '2': return renderUseTelehealthContent(item);
			case '3': return renderUpdateTestResultContent(item);
			case '4': return renderApplicationContent(item);
			default: return null;
		}
	};
	...
	const resolveGridBoxClassName = (id: string) => {
		switch (id) {
			case '1': return 'lg:col-span-2 bg-blue-primary max-lg:h-[369px]';
			case '2': return 'lg:col-span-1 bg-primary max-lg:order-3 max-lg:h-[369px]';
			case '3': return 'lg:col-span-1 bg-primary max-lg:order-1 max-lg:h-[369px]';
			case '4': return 'lg:col-span-2 bg-blue-primary max-lg:order-2 max-lg:h-[738px] !pb-0';
			default: return '';
		}
	};
