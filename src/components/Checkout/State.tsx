...
import { joinWaitList } from "./api/onboarding";
...
const ExclamationIcon = () => {
  return (
    <div className='relative w-[200px] h-[200px] lg:w-[268px] lg:h-[268px]'>
      <Band className='w-[200px] h-[200px] lg:w-[268px] lg:h-[268px] bg-[#FFAF51]/5' delay={0} />
      <Band className='w-[129.85px] h-[129.85px] lg:w-[174px] lg:h-[174px] bg-[#FFA551]/5' delay={0.25 * DURATION} />
      <Band
...
const SuccessIcon = () => {
  return (
    <div className='relative w-[200px] h-[200px] lg:w-[268px] lg:h-[268px]'>
      ...
      <Band className='w-[129.85px] h-[129.85px] lg:w-[174px] lg:h-[174px] bg-[#91FE95]/10' delay={0.25 * DURATION} />
      <Band
...
const ClockIcon = () => {
  return (
    <div className='relative w-[200px] h-[200px] lg:w-[268px] lg:h-[268px]'>
      ...
      <Band className='w-[129.85px] h-[129.85px] lg:w-[174px] lg:h-[174px] bg-[#24B0FF]/10' delay={0.25 * DURATION} />
      <Band
...
export const ButtonWrapper: React.FC<ButtonWrapperProps> = ({
  ...
  if (type === "link" && href) {
    return (
      <CustomLink href={href} className={className} externalLink={externalLink} onClick={onClick}>
        {children}
      </CustomLink>
    );
  }
...
const State: React.FC<StateProps> = ({ iconType, step, userData, onNextStep }) => {
  ...
  const titleRows = isMobile ? stateData.titleMobile.split("#") : stateData.title.split("#");
  const descriptionRows = isMobile ? stateData.descriptionMobile.split("#") : stateData.description.split("#");
  ...
  const onClickBtnPrimary = async () => {
    if (userData && userData.id && btnPrimaryData?.type === "join_waitlist") {
      setLoading(true);
      await joinWaitList({ id: userData.id.toString() });
  ...
  return (
    <div className='flex min-h-screen flex-col items-center h-full w-full font-Poppins lg:px-3 xl:px-10 2xl:px-20 pt-[87px] bg-primary lg:justify-center lg:py-3 xl:py-10'>
      <Navbar className='lg:hidden' theme='dark' />
              ...
              <div className='max-lg:max-w-[331px] mx-auto w-full mt-[8.973vh] xs:mt-[76px] lg:mt-0'>
                <h1 className='flex flex-col'>
                  {titleRows.map((text, textIdx) => {
                    return (
                      <span key={`title-${textIdx}`} className='overflow-hidden inline-block'>
                        <motion.span
                          variants={{
                            visible: {
                              y: 0,
              ...
              <div className='overflow-hidden inline-block mt-4 lg:mt-3.5'>
                <div className='flex flex-col'>
                  {descriptionRows.map((text, textIdx) => {
                    return (
                      <span key={`description-${textIdx}`} className='overflow-hidden inline-block'>
                        <motion.span
                          variants={{
                            visible: {
                              y: 0,
            ...
            >
              <motion.span
                ...
                transition={{
                  ease: "easeInOut",
                  duration: 0.75,
                  delay: titleRows.length * 0.25 + 0.85 + descriptionRows.length * 0.25,
                }}
            ...
            >
              <motion.span
                ...
                transition={{
                  ease: "easeInOut",
                  duration: 0.75,
                  delay: titleRows.length * 0.25 + 1.1 + descriptionRows.length * 0.25,
                }}
                className='inline-block w-full'
              >
