...
const FrequentlyAskedQues = () => {
  const accordionData = [
    ...
    {
      title: "Are the cost of supplements or prescription included in the membership fee?",
      content: "Content for Accordion Item 3",
    },
    {
      ...
      <div className=" container-center ">
        <div className=" md:flex flex-wrap">
            <div className=" md:w-[40%]">
                <p className=" uppercase text-sm text-[#919B9F] font-semibold">Have some questions?</p>
                <h4 className=" text-4xl font-Poppins">Frequently asked questions</h4>
            </div >
            <div className="md:w-[60%]">
              {accordionData.map((item, index) => (
                <div key={index} className="border-b border-gray-300">
                  ...
                  >
                    <h2 className="text-lg font-medium font-Poppins text-[#101828]">{item.title}</h2>
                  ...
                  <AnimatePresence>
                    {openIndex === index && (
                      ...
                      >
                        <p className="py-2 font-Poppins text-[#919B9F] leading-6 max-w-[700px]">{item.content}</p>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </div>
