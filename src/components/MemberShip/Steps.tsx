	...
	return (
		<div className='overflow-hidden bg-white lg:mx-3 lg:mt-3   rounded-[19px]'>
			<div className='h-full  w-full relative overflow-hidden'>
				<div className='container-center  pt-[52px] pb-[31px] lg:pt-[76px] lg:pb-[78.16px] flex flex-col items-center justify-center text-center'>
					<div className='text-center sm:mx-auto'>
						...
						{ stepsData.title && (
							<h2 className='font-Poppins text-primary leading-[126%] lg:leading-[107%] text-[6.3vw] xs2:text-[25px] sm:text-2xl md:text-[32px] lg:text-[42px] sm:tracking-[-1.68px]'>
									...
									return (
										<Fragment key={ stepIdx }>
											...
											<div className=' lg:hidden flex w-full space-y-[18px] justify-center items-center flex-col'>
												<button
													className={ clsxm(
														'cursor-pointer rounded-19px flex items-center justify-center flex-shrink-0 bg-blue-primary w-[62px] h-[62px] shadow-custom',
													) }
													aria-label={ `step-${step.id}` }
												>
													<Icon className={ clsxm('lg:text-primary') } />
												</button>
												<p
													className={ clsxm(
														'cursor-pointer w-full mx-auto text-center max-w-[265px] font-Poppins  text-sm leading-[134%] lg:pt-[24.84px] text-primary font-medium',
													) }
												>
													<span
														className='max-lg:text-left'
					...
					<div className='lg:hidden hidden sm:flex justify-center'>
						{ renderButtonCta() }
					</div>
				</div>
			</div>
