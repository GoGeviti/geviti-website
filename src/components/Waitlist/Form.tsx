...
const Form = (props: PageProps) => {
	...
	const { productId, priceId, totalWaitlist } = props;
		...
		>
			<div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
				...
				<div className={ clsxm(
					...
					<span className='mt-1'>There’s a <b>{ totalWaitlist }</b> people in the line, please enter the pass to skip the line.</span>
				</div>
				<div className='lg:col-span-2'>
					<Toggle
						name='havePassword'
