	...
	return (
		<>
          ...
          treatment.
				...
				<DisclaimerText>
          Purchasing a blood panel does not guarantee prescription to this
          product.
					<br />
          You must qualify to be prescribed.{ ' ' }
					<DisclaimerLink href='/'>Click Here</DisclaimerLink> to learn more.
				</DisclaimerText>
			</Column>
		</>
	);
