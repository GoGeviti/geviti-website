...
const MobileNav = (props: MobileNavProps) => {
  ...
  return (
    ...
    >
      ...
      <a className="flex items-center gap-[10px] mb-[22px]" href="/cart">
        <Image src={cartIcon} height={25} width={25} alt="" unoptimized />
        <span className="font-Poppins text-white text-[20px] tracking-tight">
          Cart
        </span>
      </a>
      <a className="flex items-center gap-[10px]" href="/">
        <Image src={dashboardIcon} height={25} width={25} alt="" unoptimized />
        <span className="font-Poppins text-white text-[20px] tracking-tight">
          Dashboard
        </span>
      </a>
