							...
							{ completelyCustomData.list.map((step, id) => {
								return (
									(
										...
										>
											<div
												className='cursor-pointer rounded-full flex items-center justify-center bg-white/20 font-Poppins text-center text-white text-[26px] font-medium w-[60px] h-[60px] -tracking-[1.04px]'
											>
												{ id + 1 }
											</div>
