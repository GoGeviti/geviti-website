				...
				{ type === 'men' ? (
					...
					<>
						<div
							...
							style={ {
								background:
                  'linear-gradient(0deg, rgba(24, 26, 28, 0.00) 20.46%, rgba(24, 26, 28, 0.72) 61.5%, rgba(24, 26, 28, 0.00) 100%)',
							} }
						/>
						<div
						...
						<div className='h-full w-full flex flex-col justify-end'>
							<div
								className={ clsxm(
									...
									type === 'men' &&
                    'max-lg:pt-[39px] max-lg:bg-backdrop-hero-membership-bottom-mobile'
								) }
							>
