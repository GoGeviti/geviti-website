...
const landingData = {
	...
	steps: {
		...
		title: 'A healthier you in just <span class="sm:hidden"><br /></span>4 easy steps.',
		btnCta: {
			href: '/onboarding',
			externalLink: false,
			text: 'Get Started',
	...
	homeKits: {
		description: 'Geviti offers a wide range of convenient and <br class="max-lg:hidden" />advanced diagnostics, all from the comfort <br class="max-lg:hidden" />of your home. From mobile phlebotomy, to <br class="max-lg:hidden" />at-home testing kits, we make health <br class="max-lg:hidden" />screening ultra accessible.',
