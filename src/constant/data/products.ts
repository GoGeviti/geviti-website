	...
	men: {
		...
		products: [
			...
			},
			{
				...
				description: 'Sermorelin Mini Troches dissolve under the tongue for rapid absorption, stimulating natural growth hormone production without the need for injections. They support anti-aging, muscle strength, and vitality.',
			...
			},
			{
				...
				description: 'The Longevity Panel uncovers hidden risks like high glucose, imbalanced cholesterol, silent inflammation, and hormone imbalances, helping you prevent chronic diseases and take control of your future. A phlebotomist will draw your blood at home, testing 70+ biomarkers. Members receive this service free every 6 months.',
				sort_description: '',
				price: 'as low as $300. Add 20 additional biomarkers for $85',
				category: { id: 2 },
				subCategory: { id: [1] },
